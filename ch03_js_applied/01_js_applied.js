...
/* 
..arr2과 같이 작성했을때, arr2 라는 배열 자체가 들어가는것이 아니라, 배열 내부의 element들을 하나씩 가지고 온다고 생각하는편이 여러분의 정신건강에 좋습니다.
즉, let arr4 = [ ...arr2, ...arr1];은 외부에 []가 있느것을 봤을때 새로 배열을 생성한 것이고, 거기에 내부에 arr2의 element들을 순서대로 집어넣고, 그 다음 arr1의 element들을 순서대로 집어
넣어서 완성했다고 해석할수 있습니다. 
*/
...
let person = getPerson(); // return 값이 JS 객체 이므로 person은 JS 객체의 객체명이 됩니다.
...
/* 
이상의 개념은 rect 및 eventhandler 관련 부분에서 자주 쓰게 되는데, 그때 다시 설명은 드릴겁니다. 
*/
